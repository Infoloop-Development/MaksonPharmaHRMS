    ...
    >
      <div className="px-4 lg:px-6 py-4 lg:py-5 border-b sidebar-divider flex items-start justify-between gap-2">
        <div>
          ...
          <div className="text-[10px] tracking-[2px] uppercase sidebar-muted mb-1">Admin Console</div>
      ...
      <nav className="sidebar-nav-scroll flex-1 py-4 px-3 overflow-y-auto">
        ...
        {showHrModules && (
          <>
            <div className="text-[10px] uppercase tracking-[2px] sidebar-muted px-3 pb-2 pt-4 font-semibold">HR modules</div>
